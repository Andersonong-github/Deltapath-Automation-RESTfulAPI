...
class OptUserProfile:
    ...
    def _create_ui(self):
        ...
        self._lbl = ttk.Label(row, text="User Profile", width=10, anchor="w")
    ...
    def search(self, keyword, customer_id=""):
        ...
        try:
            ...
            results = self.rc.search_user_profiles_by_name(resolved_name, resolved_id, code=customer_code) if self.rc else None
